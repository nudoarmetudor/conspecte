...
title: "Orientarea planului"
tip: concept
status: complet
tags: [geometrie-analitică, concept, orientare]
---

- **Sistem de orientare stângă**: pentru a descrie cadranul I, $(Ox)$ se rotește spre $(Oy)$ **contrar** acelor de ceasornic. Se consideră **pozitiv**.
- **Sistem de orientare dreaptă**: rotația se face **în sensul** acelor.
- În planul orientat pozitiv: rotațiile contrar acelor sunt pozitive, cele în sensul acelor — negative.
