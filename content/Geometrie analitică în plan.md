---
title: "Geometrie analitică în plan — index"
tip: index
status: în lucru
tags:
  - geometrie-analitică
...
```mermaid
graph TD
  S1["§1 · Figuri, paralelism<br/>apare DIRECȚIA"] --> S2["§2 · Segmente orientate<br/>apare ECHIPOLENȚA"]
  S2 --> S3["§3 · VECTORUL<br/>clasă de echivalență"]
  S3 --> S4["§4 · Adunarea<br/>prima operație"]
  S3 --> S5["§5 · Înmulțirea cu un număr<br/>a doua operație"]
  S4 --> S6["§6 · Dependența liniară<br/>ce se poate construi"]
  S5 --> S6
  S6 --> S7["§7 · SPAȚIU VECTORIAL<br/>structura completă"]
  S4 --> S7
  S5 --> S7
